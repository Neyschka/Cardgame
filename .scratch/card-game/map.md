...
(As locked at this map's destination, for the original v1 build. *2026-08-21: card art and theming were added afterward by the `game-update/` rules migration — see `spec.md`'s own "Out of scope" list for the current state.*)
